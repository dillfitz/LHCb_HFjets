                 ...
                 bool SubtractGS = false)
{
  ...
  // Int_t bins[4] = {ptbinsize, ptHFbinsize, dRbinsize, zbinsize};
  // Int_t bins[4] = {10, 10, 10, 10};
  // Double_t xmin[4] = {0., -5., 0, 10};
  // Double_t xmax[4] = {10., 5., 10, 10};
  // THnF hn_denom_test("hn", "hn", 2, bins, xmin, xmax);
  // THnF *hn_denom_test = new THnF("hn", "hn", 2, bins, xmin, xmax);
  // THnSparseF *hn_denom_test = new THnSparseF("hn", "hn", 2, bins);
  // hn_denom_test->SetBinEdges(1, pt_binedges);
  // hn_denom_test->SetBinEdges(2, ptHF_binedges);
  // hn_denom_test->SetBinEdges(3, dR_binedges);
  // hn_denom_test->SetBinEdges(4, z_binedges);
  ...
  // RooUnfoldResponse *response_test_4D = new RooUnfoldResponse(hn_denom_test, hn_denom_test, "response_4D");
  ...
  TH2D *h2_denom_efficiency_fragzjetpt = new TH2D("denom_efficiency_fragzjetpt", "", fragzbinsize, fragz_binedges, customptbinsize, custompt_binedges);
  ...
  LundTree->SetBranchAddress("nTracks", &nTracks);
  ...
  for (int ev = 0; ev < NumEvts; ev++)
  {
    ...
    bool meas_pt_cond = (meas_jet_pt > 12.5);
    ...
    if (pt_cond)
    {
      h2_denom_efficiency_jetpteta->Fill(jet_pt, jet_rap);
    }
    if (pt_cond && rap_cond)
    {
  ...
  // TEfficiency * h1_efficiency_jetrap = new TEfficiency(*h1_num_efficiency_jetrap, *h1_denom_efficiency_jetrap);
  ...
  h1_denom_efficiency_jetrap->Write("h1_denom_efficiency_jetrap");
  h2_denom_efficiency_HFptjetpt->Write("h2_denom_efficiency_HFptjetpt");
  h2_denom_efficiency_fragzjetpt->Write("h2_denom_efficiency_fragzjetpt");
  h2_denom_efficiency_HFptnTracks->Write("h2_denom_efficiency_HFptnTracks");
  h2_denom_efficiency_HFpteta->Write("h2_denom_efficiency_HFpteta");
  h3_denom_efficiency_HFptetajetpt->Write("h3_denom_efficiency_HFptetajetpt");
  h2_SVTag_eff_denom_z->Write("h2_SVTag_eff_denom_z");
  ...
  // h1_efficiency_jetrap->SetXTitle("E_{radiator}");
  // h1_efficiency_jetrap->SetYTitle("Counts");
