...
float LambdaQCD = 0.2;
float ptMin = 20.;
float ptMax = 100.; // reducing ptMax does not change much
float pMin = 0;
float pMax = 10;
float sd_z_cut = 0.10;
float sd_beta = 0.0;
...
// float kt_binedges[ktbinsize+1];
// float dR_binedges[dRbinsize+1];

// float z_binedges[zbinsize+1];
// float theta_binedges[thetabinsize+1];
// float Erad_binedges[Eradbinsize+1];

// float tr_kt_binedges[tr_ktbinsize+1];
// float tr_dR_binedges[tr_dRbinsize+1];

// float tr_z_binedges[tr_zbinsize+1];
// float tr_theta_binedges[tr_thetabinsize+1];
// float tr_Erad_binedges[tr_Eradbinsize+1];

const float kt_factor = 0.35;
const float z_factor = 0.33;
...
double z_binedges[zbinsize + 1] = {0., 0.3, log(2.0), log(2.0) + z_factor, log(2.0) + 2 * z_factor,
                                   log(2.0) + 3 * z_factor, log(2.0) + 4 * z_factor, log(2.0) + 5 * z_factor, log(2.0) + 6 * z_factor,
                                   log(2.0) + 7 * z_factor, log(2.0) + 8 * z_factor, log(2.0) + 9 * z_factor, log(2.0) + 10 * z_factor,
                                   log(2.0) + 16 * z_factor};
...
double tr_z_binedges[tr_zbinsize + 1] = {0., 0.3, log(2.0), log(2.0) + z_factor, log(2.0) + 2 * z_factor,
                                         log(2.0) + 3 * z_factor, log(2.0) + 4 * z_factor, log(2.0) + 5 * z_factor, log(2.0) + 6 * z_factor,
                                         log(2.0) + 7 * z_factor, log(2.0) + 8 * z_factor, log(2.0) + 9 * z_factor, log(2.0) + 10 * z_factor,
                                         log(2.0) + 16 * z_factor};
...
double z_binedgesfinal[zbinsizefinal + 1] = {log(2.0), log(2.0) + z_factor, log(2.0) + 2 * z_factor,
                                             log(2.0) + 3 * z_factor, log(2.0) + 4 * z_factor, log(2.0) + 5 * z_factor,
                                             log(2.0) + 6 * z_factor, log(2.0) + 7 * z_factor, log(2.0) + 8 * z_factor,
                                             log(2.0) + 9 * z_factor, log(2.0) + 10 * z_factor};
...
// float fragz_binedges[fragzbinsize + 1] = {0., 0.2, 0.3, 0.4, 0.5, 0.7, 1.0};
