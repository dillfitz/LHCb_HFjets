...
// Sat Mar 18 01:22:22 2023 by ROOT version 6.24/08
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         Jet_mcjet_TopMotherID[1024];   //[Jet0_NDtr]
   Float_t         Jet_mcjet_MotherID[1024];   //[Jet0_NDtr]
   UInt_t          nCandidate;
...
#ifdef BjetTree_cxx
BjetTree::BjetTree(TTree *tree=0, int dataset = 93539, bool isData = true) : fChain(0)
{
...
if (tree == 0) {
   ...
   if(dataset == 93599){
     ...
     if (isData)
     {
      chain->Add(data_dir + "Bjet_Dimuon_nojetid_DTF_2016_MD_05222023_url634_0_800.root/Jets/DecayTree");
      chain->Add(data_dir + "Bjet_Dimuon_nojetid_DTF_2016_MD_05222023_url634_800_1045.root/Jets/DecayTree");
      ...
      chain->Add(data_dir + "Bjet_Dimuon_nojetid_DTF_2017_MD_05222023_url636_0_746.root/Jets/DecayTree");
      chain->Add(data_dir + "Bjet_Dimuon_nojetid_DTF_2017_MU_05222023_url637_0_725.root/Jets/DecayTree");
      chain->Add(data_dir + "Bjet_Dimuon_nojetid_DTF_2018_MD_05222023_url638_0_800.root/Jets/DecayTree");
      chain->Add(data_dir + "Bjet_Dimuon_nojetid_DTF_2018_MD_05222023_url638_800_843.root/Jets/DecayTree");
      ...
      chain->Add(data_dir + "Bjet_Dimuon_nojetid_DTF_2018_MU_05222023_url639_800_897.root/Jets/DecayTree");
        ...
        chain->Add(data_dir + "Bjet_MCReco_nojetid_DFT_2018_Sim10a_MD_06092023_full.root/Jets/DecayTree");
        chain->Add(data_dir + "Bjet_MCReco_nojetid_DFT_2018_Sim10a_MU_06092023_full.root/Jets/DecayTree");
     }
     ...
     if (isData)
     {
        chain->Add(data_dir + "Bjet_Data_dimuon_2016_MD_02182023_full.root/Jets/DecayTree");
        chain->Add(data_dir + "Bjet_Data_dimuon_2016_MD_02182023_full.root/Jets/DecayTree");
        chain->Add(data_dir + "Bjet_Data_dimuon_2016_MU_02182023_full.root/Jets/DecayTree");
     ...
     if (isData)
     {
        chain->Add(data_dir + "Bjet_Data_dimuon_2017_MD_02182023_full.root/Jets/DecayTree");
        chain->Add(data_dir + "Bjet_Data_dimuon_2017_MU_02182023_full.root/Jets/DecayTree");
     ...
     if (isData)
     {
        chain->Add(data_dir + "Bjet_Data_dimuon_2018_MD_02182023_full.root/Jets/DecayTree");
        chain->Add(data_dir + "Bjet_Data_dimuon_2018_MU_02182023_full.root/Jets/DecayTree");
     ...
     if (isData)
     {
       chain->Add(data_dir + "Bjet_Data_dimuon_DTF_2016_MD_03182023_full.root/Jets/DecayTree");
       chain->Add(data_dir + "Bjet_Data_dimuon_DTF_2016_MU_03182023_full.root/Jets/DecayTree");
       chain->Add(data_dir + "Bjet_Data_dimuon_DTF_2017_MD_03182023_full.root/Jets/DecayTree");
       chain->Add(data_dir + "Bjet_Data_dimuon_DTF_2017_MU_03182023_full.root/Jets/DecayTree");
       chain->Add(data_dir + "Bjet_Data_dimuon_DTF_2018_MD_03182023_full.root/Jets/DecayTree");
       chain->Add(data_dir + "Bjet_Data_dimuon_DTF_2018_MU_03182023_full.root/Jets/DecayTree");
     }
     else{

       chain->Add(data_dir + "Bjet_MC_nojetid_DFT_Sim09k_MD_03172023_full.root/Jets/DecayTree");
       chain->Add(data_dir + "Bjet_MC_nojetid_DFT_Sim09k_MU_03172023_full.root/Jets/DecayTree");
     ...
     if (isData)
     {
      ...
      //  chain->Add(data_dir + "BuPsiK_in_jet_13TeV_nojetid_dtf.root/Jets/DecayTree");
       chain->Add(data_dir + "Bjet_MCReco_nojetid_DFT_2016_Sim09k_MD_06062023_isMC.root/Jets/DecayTree");
      //  chain->Add(data_dir + "Bjet_MCReco_nojetid_DFT_Sim09k_MU_05102023_full.root/Jets/DecayTree");
   }  
