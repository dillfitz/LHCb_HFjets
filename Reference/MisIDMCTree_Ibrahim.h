...
// Sun Dec 11 23:43:27 2022 by ROOT version 6.24/06
// from TChain mcjettuple/MCJetTree/
//////////////////////////////////////////////////////////

#ifndef MisIDMCTree_h
#define MisIDMCTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         MCJet_Dtr_mcrecomatch_px[1024];   //[MCJet_NDtr]
   Float_t         MCJet_Dtr_mcrecomatch_py[1024];   //[MCJet_NDtr]
   Float_t         MCJet_Dtr_mcrecomatch_pz[1024];   //[MCJet_NDtr]
...
#ifdef MisIDMCTree_cxx
MisIDMCTree::MisIDMCTree(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("BuPsipi_in_jet_13TeV_nojetid.root/mcjettuple/MCJetTree");
      tree = chain;
#endif // SINGLE_TREE
...
MisIDMCTree::~MisIDMCTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MisIDMCTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MisIDMCTree::LoadTree(Long64_t entry)
{
...
void MisIDMCTree::Init(TTree *tree)
{
...
void MisIDMCTree::Show(Long64_t entry)
{
...
Int_t MisIDMCTree::Cut(Long64_t entry)
{
