...
// Thu Dec 19 18:28:40 2024 by ROOT version 6.32.08
...
public:
   ...
   Double_t MCJet_M;
   Int_t MCJet_FLAV;
   Int_t MCJet_MC_MOTHER_ID;
   Int_t MCJet_MC_MOTHER_KEY;
   Int_t MCJet_MC_GD_MOTHER_ID;
   Int_t MCJet_MC_GD_MOTHER_KEY;
   Int_t MCJet_MC_GD_GD_MOTHER_ID;
   Int_t MCJet_MC_GD_GD_MOTHER_KEY;
   Int_t MCJet_HF1DTR1_ID;
   Int_t MCJet_HF1DTR2_ID;
   Int_t MCJet_NumHF1Dtrs;
   Int_t MCJet_HF2DTR1_ID;
   Int_t MCJet_HF2DTR2_ID;
   Int_t MCJet_NumHF2Dtrs;
   Double_t MCJet_HF1DTR1_PX;
   Double_t MCJet_HF1DTR1_PY;
   Double_t MCJet_HF1DTR1_PZ;
   Double_t MCJet_HF1DTR1_E;
   Double_t MCJet_HF1DTR2_PX;
   Double_t MCJet_HF1DTR2_PY;
   Double_t MCJet_HF1DTR2_PZ;
   Double_t MCJet_HF1DTR2_E;
   Double_t MCJet_HF2DTR1_PX;
   Double_t MCJet_HF2DTR1_PY;
   Double_t MCJet_HF2DTR1_PZ;
   Double_t MCJet_HF2DTR1_E;
   Double_t MCJet_HF2DTR2_PX;
   Double_t MCJet_HF2DTR2_PY;
   Double_t MCJet_HF2DTR2_PZ;
   Double_t MCJet_HF2DTR2_E;
   ...
   Double_t MCJet_truth_pi_PX;
   Double_t MCJet_truth_pi_PY;
   Double_t MCJet_truth_pi_PZ;
   Double_t MCJet_truth_pi_PE;
   Double_t MCJet_truth_pi_PT;
   Double_t MCJet_truth_pi_PHI;
   Double_t MCJet_truth_pi_ETA;
   Double_t MCJet_truth_pi_M;
   Double_t MCJet_truth_pi_XVTX;
   Double_t MCJet_truth_pi_YVTX;
   Double_t MCJet_truth_pi_ZVTX;
   ...
   Double_t MCJet_truth_Pi0_PX;
   Double_t MCJet_truth_Pi0_PY;
   Double_t MCJet_truth_Pi0_PZ;
   Double_t MCJet_truth_Pi0_PE;
   Double_t MCJet_truth_Pi0_PT;
   Double_t MCJet_truth_Pi0_PHI;
   Double_t MCJet_truth_Pi0_ETA;
   Double_t MCJet_truth_Pi0_M;
   Double_t MCJet_truth_match_pi_PX;
   Double_t MCJet_truth_match_pi_PY;
   Double_t MCJet_truth_match_pi_PZ;
   Int_t MCJet_truth_match_pi_TYPE;
   Double_t MCJet_truth_match_pi_CHI2;
   Int_t MCJet_truth_match_pi_NDOF;
   Double_t MCJet_truth_match_pi_PROBCHI2;
   Double_t MCJet_truth_match_K_PX;
   Double_t MCJet_truth_match_K_PY;
   Double_t MCJet_truth_match_K_PZ;
   Int_t MCJet_truth_match_K_TYPE;
   Double_t MCJet_truth_match_K_CHI2;
   Int_t MCJet_truth_match_K_NDOF;
   Double_t MCJet_truth_match_K_PROBCHI2;
   ...
   TBranch *b_MCJet_MC_MOTHER_ID;                 //!
   TBranch *b_MCJet_MC_MOTHER_KEY;                //!
   TBranch *b_MCJet_MC_GD_MOTHER_ID;              //!
   TBranch *b_MCJet_MC_GD_MOTHER_KEY;             //!
   TBranch *b_MCJet_MC_GD_GD_MOTHER_ID;           //!
   TBranch *b_MCJet_MC_GD_GD_MOTHER_KEY;          //!
   TBranch *b_MCJet_HF1DTR1_ID;                   //!
   TBranch *b_MCJet_HF1DTR2_ID;                   //!
   TBranch *b_MCJet_NumHF1Dtrs;                   //!
   TBranch *b_MCJet_HF2DTR1_ID;                   //!
   TBranch *b_MCJet_HF2DTR2_ID;                   //!
   TBranch *b_MCJet_NumHF2Dtrs;                   //!
   TBranch *b_MCJet_HF1DTR1_PX;                   //!
   TBranch *b_MCJet_HF1DTR1_PY;                   //!
   TBranch *b_MCJet_HF1DTR1_PZ;                   //!
   TBranch *b_MCJet_HF1DTR1_E;                    //!
   TBranch *b_MCJet_HF1DTR2_PX;                   //!
   TBranch *b_MCJet_HF1DTR2_PY;                   //!
   TBranch *b_MCJet_HF1DTR2_PZ;                   //!
   TBranch *b_MCJet_HF1DTR2_E;                    //!
   TBranch *b_MCJet_HF2DTR1_PX;                   //!
   TBranch *b_MCJet_HF2DTR1_PY;                   //!
   TBranch *b_MCJet_HF2DTR1_PZ;                   //!
   TBranch *b_MCJet_HF2DTR1_E;                    //!
   TBranch *b_MCJet_HF2DTR2_PX;                   //!
   TBranch *b_MCJet_HF2DTR2_PY;                   //!
   TBranch *b_MCJet_HF2DTR2_PZ;                   //!
   TBranch *b_MCJet_HF2DTR2_E;                    //!
   ...
   TBranch *b_MCJet_truth_pi_PX;                  //!
   TBranch *b_MCJet_truth_pi_PY;                  //!
   TBranch *b_MCJet_truth_pi_PZ;                  //!
   TBranch *b_MCJet_truth_pi_PE;                  //!
   TBranch *b_MCJet_truth_pi_PT;                  //!
   TBranch *b_MCJet_truth_pi_PHI;                 //!
   TBranch *b_MCJet_truth_pi_ETA;                 //!
   TBranch *b_MCJet_truth_pi_M;                   //!
   TBranch *b_MCJet_truth_pi_XVTX;                //!
   TBranch *b_MCJet_truth_pi_YVTX;                //!
   TBranch *b_MCJet_truth_pi_ZVTX;                //!
   ...
   TBranch *b_MCJet_truth_Pi0_PX;                 //!
   TBranch *b_MCJet_truth_Pi0_PY;                 //!
   TBranch *b_MCJet_truth_Pi0_PZ;                 //!
   TBranch *b_MCJet_truth_Pi0_PE;                 //!
   TBranch *b_MCJet_truth_Pi0_PT;                 //!
   TBranch *b_MCJet_truth_Pi0_PHI;                //!
   TBranch *b_MCJet_truth_Pi0_ETA;                //!
   TBranch *b_MCJet_truth_Pi0_M;                  //!

   TBranch *b_MCJet_truth_match_pi_PX;            //!
   TBranch *b_MCJet_truth_match_pi_PY;            //!
   TBranch *b_MCJet_truth_match_pi_PZ;            //!
   TBranch *b_MCJet_truth_match_pi_TYPE;          //!
   TBranch *b_MCJet_truth_match_pi_CHI2;          //!
   TBranch *b_MCJet_truth_match_pi_NDOF;          //!
   TBranch *b_MCJet_truth_match_pi_PROBCHI2;      //!
   TBranch *b_MCJet_truth_match_K_PX;             //!
   TBranch *b_MCJet_truth_match_K_PY;             //!
   TBranch *b_MCJet_truth_match_K_PZ;             //!
   TBranch *b_MCJet_truth_match_K_TYPE;           //!
   TBranch *b_MCJet_truth_match_K_CHI2;           //!
   TBranch *b_MCJet_truth_match_K_NDOF;           //!
   TBranch *b_MCJet_truth_match_K_PROBCHI2;       //!
   ...
   MCJetTree(TTree *tree = 0, int dataset = 93499, bool isData = true);
   virtual ~MCJetTree();
...
#ifdef MCJetTree_cxx
MCJetTree::MCJetTree(TTree *tree, int dataset, bool isData) : fChain(0)
{
   ...
   if (tree == 0)
   {
      ...
      if (dataset == 93499)
      {
         ...
         if (isData)
         {
            ...
            chain->Add(data_dir + "Djet_2016_MD_09082022_url327_0_535.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_2016_MU_09082022_url328_0_452.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_2017_MD_09082022_url329_0_345.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_2017_MU_09082022_url330_0_327.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_2018_MD_09082022_url331_0_372.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_2018_MU_09082022_url332_0_392.root/mcjettuple/MCJetTree");
         }
         else
         {
            chain->Add(data_dir + "Djet_MC_Sim09_2016_MD_09152022_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_Sim09_2016_MU_09152022_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_Sim09_2017_MD_09182022_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_Sim09_2017_MU_09182022_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_Sim09_2018_MD_09182022_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_Sim09_2018_MU_09182022_full.root/mcjettuple/MCJetTree");
      ...
      if (dataset == 90499)
      {
         ...
         if (isData)
         {
            ...
            chain->Add(data_dir + "Djet_nojetid_2016_MU_01122024.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_nojetid_2016_MD_01122024.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_nojetid_2017_MU_01122024.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_nojetid_2017_MD_01122024.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_nojetid_2018_MU_01122024.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_nojetid_2018_MD_01122024.root/mcjettuple/MCJetTree");
         }
         else
         {

            chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2016_MD_01152024_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2016_MU_01152024_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2017_MD_01152024_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2017_MU_01152024_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2018_MD_01152024_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2018_MU_01152024_full.root/mcjettuple/MCJetTree");
         }
      }
      if (dataset == 60490)
      {
         ...
         if (isData)
         {
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_0.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_50.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_100.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_150.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_200.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_250.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_300.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_350.root/mcjettuple/MCJetTree");
            // chain->Add(data_dir + "D2KKPi_Data_2016_MD_11252024.root/mcjettuple/MCJetTree");
            // chain->Add(data_dir + "D2KKPi_Data_2016_MD_06222024.root/mcjettuple/MCJetTree");
            // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
         }
         else
         {
            // data_dir = "/afs/cern.ch/work/i/ichahrou/LundPlane/DaVinci/D02KPiPi0_R/";  
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt50_2016_MD_02232025_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt510_2016_MD_02232025_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1015_2016_MD_02232025_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1520_2016_MD_02232025_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt2050_2016_MD_02232025_full.root/mcjettuple/MCJetTree");
         }
      }
      if (dataset == 60491)
      {
         ...
         if (isData)
         {
            ...
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_0_50.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_50_100.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_100_150.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_150_200.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_200_250.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_250_300.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_300_350.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_350_400.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_400_450.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_500_550.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_550_600.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MU_12032024_600_640.root/mcjettuple/MCJetTree");
         }
         else
         {

            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt50_2016_MU_02232025_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt510_2016_MU_02232025_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1015_2016_MU_02232025_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1520_2016_MU_02232025_full.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt2050_2016_MU_02232025_full.root/mcjettuple/MCJetTree");
      ...
      if (dataset == 70490)
      {
         ...
         if (isData)
         {
            ...
            chain->Add(data_dir + "D2KKPi_Data_2017_MD_11252024.root/mcjettuple/MCJetTree");
         }
         else
         {

            chain->Add(data_dir + "D2KKPi_MC_Sim10c_2017_MD_06182024_full.root/mcjettuple/MCJetTree");
         }
      }
      if (dataset == 70491)
      {
         ...
         if (isData)
         {
            ...
            chain->Add(data_dir + "D2KKPi_Data_2017_MU_11252024.root/mcjettuple/MCJetTree");
         }
         else
         {

            chain->Add(data_dir + "D2KKPi_MC_Sim10c_2017_MU_06182024_full.root/mcjettuple/MCJetTree");
         }
      }
      if (dataset == 80490)
      {
         ...
         if (isData)
         {
            ...
            chain->Add(data_dir + "D2KKPi_Data_2018_MD_11252024.root/mcjettuple/MCJetTree");
         }
         else
         {

            chain->Add(data_dir + "D2KKPi_MC_Sim10c_2018_MD_06182024_full.root/mcjettuple/MCJetTree");
         }
      }
      if (dataset == 80491)
      {
         ...
         if (isData)
         {
            ...
            chain->Add(data_dir + "D2KKPi_Data_2018_MU_11252024.root/mcjettuple/MCJetTree");
         }
         else
         {

            chain->Add(data_dir + "D2KKPi_MC_Sim10c_2018_MU_06182024_full.root/mcjettuple/MCJetTree");
         }
      }
      ...
      {
         if (isData)
            chain->Add(data_dir + "D2KKPi_Data_Decay_2016_MD_07302024.root/mcjettuple/MCJetTree");
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
         else
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt510_2016_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      ...
      if (dataset == 71400)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt510_2017_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 71401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt510_2017_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 81400)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt510_2018_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 81401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt510_2018_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 62400)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1015_2016_MD_02232025_full.root/mcjettuple/MCJetTree");
         // chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1015_2016_MD_10012024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 62401)
      {
         if (isData)
      ...
      if (dataset == 72400)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1015_2017_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 72401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1015_2017_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 82400)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1015_2018_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 82401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1015_2018_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 63400)
      ...
      if (dataset == 73400)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1520_2017_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 73401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1520_2017_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 83400)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1520_2018_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 83401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1520_2018_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 64400)
      ...
      if (dataset == 74400)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt2050_2017_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 74401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt2050_2017_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 84400)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt2050_2018_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 84401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt2050_2018_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 65400)
      ...
      if (dataset == 75400)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt50_2017_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 75401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt50_2017_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 85400)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt50_2018_MD_02232025_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 85401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt50_2018_MU_02232025_full.root/mcjettuple/MCJetTree");
      }
      ...
      if (dataset == 67400)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D2KKPi_MC_Sim10c_2016_MD_06182024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 67401)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D2KKPi_MC_Sim10c_2016_MU_06182024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 77400)
      {
         if (isData)
      ...
      if (dataset == 61410)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt510_2016_MD_08182024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 61411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt510_2016_MU_08182024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 71410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt510_2017_MD_08182024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 71411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt510_2017_MU_08182024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 81410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt510_2018_MD_08182024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 81411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt510_2018_MU_08182024_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 62410)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1015_2016_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 62411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1015_2016_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 72410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1015_2017_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 72411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1015_2017_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 82410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1015_2018_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 82411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1015_2018_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 63410)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1520_2016_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 63411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1520_2016_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 73410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1520_2017_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 73411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1520_2017_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 83410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1520_2018_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 83411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt1520_2018_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 64410)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt2050_2016_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 64411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt2050_2016_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 74410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt2050_2017_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 74411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt2050_2017_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 84410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt2050_2018_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 84411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt2050_2018_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 65410)
      {
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt50_2016_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 65411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt50_2016_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 75410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt50_2017_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 75411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt50_2017_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 85410)
      {
         if (isData)
         ...
         // chain->Add(data_dir + "Djet_Data_2016_MD_01122024.root/mcjettuple/MCJetTree");
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt50_2018_MD_08192024_full.root/mcjettuple/MCJetTree");
      }
      if (dataset == 85411)
      {
         if (isData)
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_Nonprompt_pt50_2018_MU_08192024_full.root/mcjettuple/MCJetTree");
      }
      //////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////
      if (dataset == 66410)
      ...
      {
         std::cout << "Got MagUp Data" << std::endl;
         chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2016_MU_02092023_full.root/mcjettuple/MCJetTree");
         chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2017_MU_02092023_full.root/mcjettuple/MCJetTree");
         chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2018_MU_02092023_full.root/mcjettuple/MCJetTree");
      }
      else if (dataset == 90490)
      {
         std::cout << "Got MagDown Data" << std::endl;
         chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2016_MD_02092023_full.root/mcjettuple/MCJetTree");
         chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2017_MD_02092023_full.root/mcjettuple/MCJetTree");
         chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2018_MD_02092023_full.root/mcjettuple/MCJetTree");
      }
      else if (dataset == 99499)
      {
         ...
         if (isData)
         {
            ...
            // chain->Add(data_dir + "Dst_Resolved_in_jet_13TeV_nojetid.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_0.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_50.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_100.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "D02KPiPi0_2016_MD_12032024_1902_150.root/mcjettuple/MCJetTree");
         ...
         else
         {
            ...
            chain->Add(data_dir + "D0R_in_jet_13TeV_nojetid.root/mcjettuple/MCJetTree");

            // chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2018_MU_01142024_full.root/mcjettuple/MCJetTree");
            // chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2016_MD_01182024_full.root/mcjettuple/MCJetTree");
         }
         // chain->Add(data_dir + "Djet_MCReco_nojetid_Sim09l_2016_MD_04262023_full.root/mcjettuple/MCJetTree");
         // chain->Add(data_dir + "Djet_MCReco_nojetid_Sim09l_2016_MU_04262023_full.root/mcjettuple/MCJetTree");
         //   chain->Add(data_dir + "Djet_MC_nojetid_Sim09l_2016_MU_02092023_full.root/mcjettuple/MCJetTree");
      }
      else if (dataset == 99489)
      {
         data_dir = "/afs/cern.ch/work/i/ichahrou/LundPlane/DaVinci/D02KPiPi0_R/";
         if (isData)
         {
            ...
            // data_dir = "/afs/cern.ch/work/i/ichahrou/LundPlane/DaVinci/D2KKPi/Turbo/";
            // chain->Add(data_dir + "Dst_Resolved_in_jet_13TeV_nojetid.root/mcjettuple/MCJetTree");
            // chain->Add(data_dir + "D0R_nobans_in_jet_13TeV_nojetid.root/mcjettuple/MCJetTree");
            chain->Add(data_dir + "Dst_Resolved_in_jet_13TeV_nojetid.root/mcjettuple/MCJetTree");
         }
         else
         {
            ...
            chain->Add(data_dir + "D02KPiPi0_R_MC_Sim10e_pt1520_2016_MD_11232024_full.root/mcjettuple/MCJetTree");
...
Int_t MCJetTree::GetEntry(Long64_t entry)
{
...
Long64_t MCJetTree::LoadTree(Long64_t entry)
{
...
void MCJetTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("parton1_KEY", &parton1_KEY, &b_parton1_KEY);
   ...
   fChain->SetBranchAddress("parton2_KEY", &parton2_KEY, &b_parton2_KEY);
   ...
   fChain->SetBranchAddress("MCJet_MC_MOTHER_ID", &MCJet_MC_MOTHER_ID, &b_MCJet_MC_MOTHER_ID);
   fChain->SetBranchAddress("MCJet_MC_MOTHER_KEY", &MCJet_MC_MOTHER_KEY, &b_MCJet_MC_MOTHER_KEY);
   fChain->SetBranchAddress("MCJet_MC_GD_MOTHER_ID", &MCJet_MC_GD_MOTHER_ID, &b_MCJet_MC_GD_MOTHER_ID);
   fChain->SetBranchAddress("MCJet_MC_GD_MOTHER_KEY", &MCJet_MC_GD_MOTHER_KEY, &b_MCJet_MC_GD_MOTHER_KEY);
   fChain->SetBranchAddress("MCJet_MC_GD_GD_MOTHER_ID", &MCJet_MC_GD_GD_MOTHER_ID, &b_MCJet_MC_GD_GD_MOTHER_ID);
   fChain->SetBranchAddress("MCJet_MC_GD_GD_MOTHER_KEY", &MCJet_MC_GD_GD_MOTHER_KEY, &b_MCJet_MC_GD_GD_MOTHER_KEY);
   fChain->SetBranchAddress("MCJet_HF1DTR1_ID", &MCJet_HF1DTR1_ID, &b_MCJet_HF1DTR1_ID);
   fChain->SetBranchAddress("MCJet_HF1DTR2_ID", &MCJet_HF1DTR2_ID, &b_MCJet_HF1DTR2_ID);
   fChain->SetBranchAddress("MCJet_NumHF1Dtrs", &MCJet_NumHF1Dtrs, &b_MCJet_NumHF1Dtrs);
   fChain->SetBranchAddress("MCJet_HF2DTR1_ID", &MCJet_HF2DTR1_ID, &b_MCJet_HF2DTR1_ID);
   fChain->SetBranchAddress("MCJet_HF2DTR2_ID", &MCJet_HF2DTR2_ID, &b_MCJet_HF2DTR2_ID);
   fChain->SetBranchAddress("MCJet_NumHF2Dtrs", &MCJet_NumHF2Dtrs, &b_MCJet_NumHF2Dtrs);
   fChain->SetBranchAddress("MCJet_HF1DTR1_PX", &MCJet_HF1DTR1_PX, &b_MCJet_HF1DTR1_PX);
   fChain->SetBranchAddress("MCJet_HF1DTR1_PY", &MCJet_HF1DTR1_PY, &b_MCJet_HF1DTR1_PY);
   fChain->SetBranchAddress("MCJet_HF1DTR1_PZ", &MCJet_HF1DTR1_PZ, &b_MCJet_HF1DTR1_PZ);
   fChain->SetBranchAddress("MCJet_HF1DTR1_E", &MCJet_HF1DTR1_E, &b_MCJet_HF1DTR1_E);
   fChain->SetBranchAddress("MCJet_HF1DTR2_PX", &MCJet_HF1DTR2_PX, &b_MCJet_HF1DTR2_PX);
   fChain->SetBranchAddress("MCJet_HF1DTR2_PY", &MCJet_HF1DTR2_PY, &b_MCJet_HF1DTR2_PY);
   fChain->SetBranchAddress("MCJet_HF1DTR2_PZ", &MCJet_HF1DTR2_PZ, &b_MCJet_HF1DTR2_PZ);
   fChain->SetBranchAddress("MCJet_HF1DTR2_E", &MCJet_HF1DTR2_E, &b_MCJet_HF1DTR2_E);
   fChain->SetBranchAddress("MCJet_HF2DTR1_PX", &MCJet_HF2DTR1_PX, &b_MCJet_HF2DTR1_PX);
   fChain->SetBranchAddress("MCJet_HF2DTR1_PY", &MCJet_HF2DTR1_PY, &b_MCJet_HF2DTR1_PY);
   fChain->SetBranchAddress("MCJet_HF2DTR1_PZ", &MCJet_HF2DTR1_PZ, &b_MCJet_HF2DTR1_PZ);
   fChain->SetBranchAddress("MCJet_HF2DTR1_E", &MCJet_HF2DTR1_E, &b_MCJet_HF2DTR1_E);
   fChain->SetBranchAddress("MCJet_HF2DTR2_PX", &MCJet_HF2DTR2_PX, &b_MCJet_HF2DTR2_PX);
   fChain->SetBranchAddress("MCJet_HF2DTR2_PY", &MCJet_HF2DTR2_PY, &b_MCJet_HF2DTR2_PY);
   fChain->SetBranchAddress("MCJet_HF2DTR2_PZ", &MCJet_HF2DTR2_PZ, &b_MCJet_HF2DTR2_PZ);
   fChain->SetBranchAddress("MCJet_HF2DTR2_E", &MCJet_HF2DTR2_E, &b_MCJet_HF2DTR2_E);
   ...
   fChain->SetBranchAddress("MCJet_truth_pi_PX", &MCJet_truth_pi_PX, &b_MCJet_truth_pi_PX);
   fChain->SetBranchAddress("MCJet_truth_pi_PY", &MCJet_truth_pi_PY, &b_MCJet_truth_pi_PY);
   fChain->SetBranchAddress("MCJet_truth_pi_PZ", &MCJet_truth_pi_PZ, &b_MCJet_truth_pi_PZ);
   fChain->SetBranchAddress("MCJet_truth_pi_PE", &MCJet_truth_pi_PE, &b_MCJet_truth_pi_PE);
   fChain->SetBranchAddress("MCJet_truth_pi_PT", &MCJet_truth_pi_PT, &b_MCJet_truth_pi_PT);
   fChain->SetBranchAddress("MCJet_truth_pi_PHI", &MCJet_truth_pi_PHI, &b_MCJet_truth_pi_PHI);
   fChain->SetBranchAddress("MCJet_truth_pi_ETA", &MCJet_truth_pi_ETA, &b_MCJet_truth_pi_ETA);
   fChain->SetBranchAddress("MCJet_truth_pi_M", &MCJet_truth_pi_M, &b_MCJet_truth_pi_M);
   fChain->SetBranchAddress("MCJet_truth_pi_XVTX", &MCJet_truth_pi_XVTX, &b_MCJet_truth_pi_XVTX);
   fChain->SetBranchAddress("MCJet_truth_pi_YVTX", &MCJet_truth_pi_YVTX, &b_MCJet_truth_pi_YVTX);
   fChain->SetBranchAddress("MCJet_truth_pi_ZVTX", &MCJet_truth_pi_ZVTX, &b_MCJet_truth_pi_ZVTX);
   ...
   fChain->SetBranchAddress("MCJet_truth_Pi0_PX", &MCJet_truth_Pi0_PX, &b_MCJet_truth_Pi0_PX);
   fChain->SetBranchAddress("MCJet_truth_Pi0_PY", &MCJet_truth_Pi0_PY, &b_MCJet_truth_Pi0_PY);
   fChain->SetBranchAddress("MCJet_truth_Pi0_PZ", &MCJet_truth_Pi0_PZ, &b_MCJet_truth_Pi0_PZ);
   fChain->SetBranchAddress("MCJet_truth_Pi0_PE", &MCJet_truth_Pi0_PE, &b_MCJet_truth_Pi0_PE);
   fChain->SetBranchAddress("MCJet_truth_Pi0_PT", &MCJet_truth_Pi0_PT, &b_MCJet_truth_Pi0_PT);
   fChain->SetBranchAddress("MCJet_truth_Pi0_PHI", &MCJet_truth_Pi0_PHI, &b_MCJet_truth_Pi0_PHI);
   fChain->SetBranchAddress("MCJet_truth_Pi0_ETA", &MCJet_truth_Pi0_ETA, &b_MCJet_truth_Pi0_ETA);
   fChain->SetBranchAddress("MCJet_truth_Pi0_M", &MCJet_truth_Pi0_M, &b_MCJet_truth_Pi0_M);
   fChain->SetBranchAddress("MCJet_truth_match_pi_PX", &MCJet_truth_match_pi_PX, &b_MCJet_truth_match_pi_PX);
   fChain->SetBranchAddress("MCJet_truth_match_pi_PY", &MCJet_truth_match_pi_PY, &b_MCJet_truth_match_pi_PY);
   fChain->SetBranchAddress("MCJet_truth_match_pi_PZ", &MCJet_truth_match_pi_PZ, &b_MCJet_truth_match_pi_PZ);
   fChain->SetBranchAddress("MCJet_truth_match_pi_TYPE", &MCJet_truth_match_pi_TYPE, &b_MCJet_truth_match_pi_TYPE);
   fChain->SetBranchAddress("MCJet_truth_match_pi_CHI2", &MCJet_truth_match_pi_CHI2, &b_MCJet_truth_match_pi_CHI2);
   fChain->SetBranchAddress("MCJet_truth_match_pi_NDOF", &MCJet_truth_match_pi_NDOF, &b_MCJet_truth_match_pi_NDOF);
   fChain->SetBranchAddress("MCJet_truth_match_pi_PROBCHI2", &MCJet_truth_match_pi_PROBCHI2, &b_MCJet_truth_match_pi_PROBCHI2);
   fChain->SetBranchAddress("MCJet_truth_match_K_PX", &MCJet_truth_match_K_PX, &b_MCJet_truth_match_K_PX);
   fChain->SetBranchAddress("MCJet_truth_match_K_PY", &MCJet_truth_match_K_PY, &b_MCJet_truth_match_K_PY);
   fChain->SetBranchAddress("MCJet_truth_match_K_PZ", &MCJet_truth_match_K_PZ, &b_MCJet_truth_match_K_PZ);
   fChain->SetBranchAddress("MCJet_truth_match_K_TYPE", &MCJet_truth_match_K_TYPE, &b_MCJet_truth_match_K_TYPE);
   fChain->SetBranchAddress("MCJet_truth_match_K_CHI2", &MCJet_truth_match_K_CHI2, &b_MCJet_truth_match_K_CHI2);
   fChain->SetBranchAddress("MCJet_truth_match_K_NDOF", &MCJet_truth_match_K_NDOF, &b_MCJet_truth_match_K_NDOF);
   fChain->SetBranchAddress("MCJet_truth_match_K_PROBCHI2", &MCJet_truth_match_K_PROBCHI2, &b_MCJet_truth_match_K_PROBCHI2);
...
void MCJetTree::Show(Long64_t entry)
{
...
Int_t MCJetTree::Cut(Long64_t entry)
{
