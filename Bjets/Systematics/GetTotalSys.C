                 ...
                 int NumIters = 4)
{
  ...
  TString string_matching, string_JES, string_JER, string_JESJER;
  ...
  TFile *file_JESJER = new TFile(string_JESJER + TString(".root"), "READ");
...
//                                "JES",
  ...
  TH1D *h1_z_ptbinned_sys_jetid[ptbinsize-1], /* *h1_z_ptbinned_sys_jer[ptbinsize-1], *h1_z_ptbinned_sys_jes[ptbinsize-1],*/ *h1_z_ptbinned_sys_jesjer[ptbinsize-1];
  ...
  TH1D *h1_z_ptbinned_sys_jetid_sq[ptbinsize-1], /* *h1_z_ptbinned_sys_jer_sq[ptbinsize-1], *h1_z_ptbinned_sys_jes_sq[ptbinsize-1], */ *h1_z_ptbinned_sys_jesjer_sq[ptbinsize-1];
  ...
  TH1D *h1_jt_ptbinned_sys_jetid[ptbinsize-1], /* *h1_jt_ptbinned_sys_jer[ptbinsize-1], *h1_jt_ptbinned_sys_jes[ptbinsize-1], */ *h1_jt_ptbinned_sys_jesjer[ptbinsize-1];
  ...
  TH1D *h1_jt_ptbinned_sys_jetid_sq[ptbinsize-1], /* *h1_jt_ptbinned_sys_jer_sq[ptbinsize-1], *h1_jt_ptbinned_sys_jes_sq[ptbinsize-1], */ *h1_jt_ptbinned_sys_jesjer_sq[ptbinsize-1];
  ...
  TH1D *h1_r_ptbinned_sys_jetid[ptbinsize-1], /* *h1_r_ptbinned_sys_jer[ptbinsize-1], *h1_r_ptbinned_sys_jes[ptbinsize-1], */ *h1_r_ptbinned_sys_jesjer[ptbinsize-1];
  ...
  TH1D *h1_r_ptbinned_sys_jetid_sq[ptbinsize-1], /* *h1_r_ptbinned_sys_jer_sq[ptbinsize-1], *h1_r_ptbinned_sys_jes_sq[ptbinsize-1], */ *h1_r_ptbinned_sys_jesjer_sq[ptbinsize-1];
  ...
  TH2D *h2_zjt_ptbinned_sys_jetid[ptbinsize-1], /* *h2_zjt_ptbinned_sys_jer[ptbinsize-1], *h2_zjt_ptbinned_sys_jes[ptbinsize-1], */ *h2_zjt_ptbinned_sys_jesjer[ptbinsize-1];
  ...
  TH2D *h2_zjt_ptbinned_sys_jetid_sq[ptbinsize-1], /* *h2_zjt_ptbinned_sys_jer_sq[ptbinsize-1], *h2_zjt_ptbinned_sys_jes_sq[ptbinsize-1], */ *h2_zjt_ptbinned_sys_jesjer_sq[ptbinsize-1];
  ...
  TH2D *h2_zr_ptbinned_sys_jetid[ptbinsize-1], /* *h2_zr_ptbinned_sys_jer[ptbinsize-1], *h2_zr_ptbinned_sys_jes[ptbinsize-1], */ *h2_zr_ptbinned_sys_jesjer[ptbinsize-1];
  ...
  TH2D *h2_zr_ptbinned_sys_jetid_sq[ptbinsize-1], /* *h2_zr_ptbinned_sys_jer_sq[ptbinsize-1], *h2_zr_ptbinned_sys_jes_sq[ptbinsize-1], */ *h2_zr_ptbinned_sys_jesjer_sq[ptbinsize-1];
  ...
  TH2D *h2_jtr_ptbinned_sys_jetid[ptbinsize-1], /* *h2_jtr_ptbinned_sys_jer[ptbinsize-1], *h2_jtr_ptbinned_sys_jes[ptbinsize-1], */ *h2_jtr_ptbinned_sys_jesjer[ptbinsize-1];
  ...
  TH2D *h2_jtr_ptbinned_sys_jetid_sq[ptbinsize-1], /* *h2_jtr_ptbinned_sys_jer_sq[ptbinsize-1], *h2_jtr_ptbinned_sys_jes_sq[ptbinsize-1], */ *h2_jtr_ptbinned_sys_jesjer_sq[ptbinsize-1];
  ...
  h1_z_ptbinned_sys_jesjer[i-1] = (TH1D *)file_JESJER->Get(Form("z_pt%d_ratio", i));
  ...
  h1_jt_ptbinned_sys_jesjer[i-1] = (TH1D *)file_JESJER->Get(Form("jt_pt%d_ratio", i));
  ...
  h1_r_ptbinned_sys_jesjer[i-1] = (TH1D *)file_JESJER->Get(Form("r_pt%d_ratio", i));
  ...
  h2_zjt_ptbinned_sys_jesjer[i-1] = (TH2D *)file_JESJER->Get(Form("zjt_pt%d_ratio", i));
  ...
  h2_zr_ptbinned_sys_jesjer[i-1] = (TH2D *)file_JESJER->Get(Form("zr_pt%d_ratio", i));
  ...
  h2_jtr_ptbinned_sys_jesjer[i-1] = (TH2D *)file_JESJER->Get(Form("jtr_pt%d_ratio", i));
  ...
  h1_z_ptbinned_sys_jesjer_sq[i-1] = (TH1D *)h1_z_ptbinned_sys_jesjer[i-1]->Clone(Form("z_pt%d_sys_jesjer_sq", i));
  ...
  h1_jt_ptbinned_sys_jesjer_sq[i-1] = (TH1D *)h1_jt_ptbinned_sys_jesjer[i-1]->Clone(Form("jt_pt%d_sys_jesjer_sq", i));
  ...
  h1_r_ptbinned_sys_jesjer_sq[i-1] = (TH1D *)h1_r_ptbinned_sys_jesjer[i-1]->Clone(Form("r_pt%d_sys_jesjer_sq", i));
  ...
  h2_zjt_ptbinned_sys_jesjer_sq[i-1] = (TH2D *)h2_zjt_ptbinned_sys_jesjer[i-1]->Clone(Form("zjt_pt%d_sys_jesjer_sq", i));
  ...
  h2_zr_ptbinned_sys_jesjer_sq[i-1] = (TH2D *)h2_zr_ptbinned_sys_jesjer[i-1]->Clone(Form("zr_pt%d_sys_jesjer_sq", i));
  ...
  h2_jtr_ptbinned_sys_jesjer_sq[i-1] = (TH2D *)h2_jtr_ptbinned_sys_jesjer[i-1]->Clone(Form("jtr_pt%d_sys_jesjer_sq", i));
  ...
  h1_z_ptbinned_sys_total[i-1] = (TH1D *)h1_z_ptbinned_sys_jesjer[i-1]->Clone(Form("z_pt%d_total_sys",i));
  h1_jt_ptbinned_sys_total[i-1] = (TH1D *)h1_jt_ptbinned_sys_jesjer[i-1]->Clone(Form("jt_pt%d_total_sys",i));
  h1_r_ptbinned_sys_total[i-1] = (TH1D *)h1_r_ptbinned_sys_jesjer[i-1]->Clone(Form("r_pt%d_total_sys",i));
  h2_zjt_ptbinned_sys_total[i-1] = (TH2D *)h2_zjt_ptbinned_sys_jesjer[i-1]->Clone(Form("zjt_pt%d_total_sys",i));
  h2_zr_ptbinned_sys_total[i-1] = (TH2D *)h2_zr_ptbinned_sys_jesjer[i-1]->Clone(Form("zr_pt%d_total_sys",i));
  h2_jtr_ptbinned_sys_total[i-1] = (TH2D *)h2_jtr_ptbinned_sys_jesjer[i-1]->Clone(Form("jtr_pt%d_total_sys",i));


  // Square (and combine where applicable)
  SetHistConst(h1_z_ptbinned_sys_total[i-1], 0.);
  h1_z_ptbinned_sys_jesjer_sq[i-1]->Multiply(h1_z_ptbinned_sys_jesjer[i-1], h1_z_ptbinned_sys_jesjer[i-1]);
  ...
  for (int xi = 0; xi < h1_z_ptbinned_sys_closure_sq[i-1]->GetNbinsX(); ++xi)
  {
    h1_z_ptbinned_sys_closure_sq[i-1]->SetBinContent(xi, h1_z_ptbinned_sys_closure_sq[i-1]->GetBinContent(xi) - h1_z_ptbinned_sys_closure_sq[i-1]->GetBinError(xi));
  }
  for (int xi = 0; xi < h1_z_ptbinned_sys_shapeclosure[i-1]->GetNbinsX(); ++xi)
  {
    h1_z_ptbinned_sys_shapeclosure_sq[i-1]->SetBinContent(xi, h1_z_ptbinned_sys_shapeclosure_sq[i-1]->GetBinContent(xi) - h1_z_ptbinned_sys_shapeclosure_sq[i-1]->GetBinError(xi));
  }
  MakeHistPositive(h1_z_ptbinned_sys_closure_sq[i-1]);
  MakeHistPositive(h1_z_ptbinned_sys_shapeclosure_sq[i-1]);
  ...
  h1_z_ptbinned_sys_unfold_sq[i-1]->Scale(1. / 4.);
  ...
  h1_z_ptbinned_sys_total[i-1]->Add(h1_z_ptbinned_sys_jesjer_sq[i-1]);
  ...
  h1_jt_ptbinned_sys_jesjer_sq[i-1]->Multiply(h1_jt_ptbinned_sys_jesjer[i-1], h1_jt_ptbinned_sys_jesjer[i-1]);
  ...
  h1_jt_ptbinned_sys_unfold_sq[i-1]->Scale(1. / 4.);
  ...
  h1_jt_ptbinned_sys_total[i-1]->Add(h1_jt_ptbinned_sys_jesjer_sq[i-1]);
  ...
  h1_r_ptbinned_sys_jesjer_sq[i-1]->Multiply(h1_r_ptbinned_sys_jesjer[i-1], h1_r_ptbinned_sys_jesjer[i-1]);
  ...
  for (int xi = 0; xi < h1_r_ptbinned_sys_closure_sq[i-1]->GetNbinsX(); ++xi)
  {
    h1_r_ptbinned_sys_closure_sq[i-1]->SetBinContent(xi, h1_r_ptbinned_sys_closure_sq[i-1]->GetBinContent(xi) - h1_r_ptbinned_sys_closure_sq[i-1]->GetBinError(xi));
  }
  for (int xi = 0; xi < h1_z_ptbinned_sys_shapeclosure_sq[i-1]->GetNbinsX(); ++xi)
  {
    h1_r_ptbinned_sys_shapeclosure_sq[i-1]->SetBinContent(xi, h1_r_ptbinned_sys_shapeclosure_sq[i-1]->GetBinContent(xi) - h1_r_ptbinned_sys_shapeclosure_sq[i-1]->GetBinError(xi));
  }
  MakeHistPositive(h1_r_ptbinned_sys_closure_sq[i-1]);
  MakeHistPositive(h1_r_ptbinned_sys_shapeclosure_sq[i-1]);
  ...
  h1_r_ptbinned_sys_unfold_sq[i-1]->Scale(1. / 4.);
  ...
  h1_r_ptbinned_sys_total[i-1]->Add(h1_r_ptbinned_sys_jesjer_sq[i-1]);
  ...
  h2_zjt_ptbinned_sys_jesjer_sq[i-1]->Multiply(h2_zjt_ptbinned_sys_jesjer[i-1], h2_zjt_ptbinned_sys_jesjer[i-1]);
  ...
  {
    for (int yi = 0; yi < h2_zjt_ptbinned_sys_closure_sq[i-1]->GetNbinsY(); ++yi)
    {
      h2_zjt_ptbinned_sys_closure_sq[i-1]->SetBinContent(xi, yi, h2_zjt_ptbinned_sys_closure_sq[i-1]->GetBinContent(xi, yi) - h2_zjt_ptbinned_sys_closure_sq[i-1]->GetBinError(xi, yi));
    }
  }
  for (int xi = 0; xi < h2_zjt_ptbinned_sys_shapeclosure_sq[i-1]->GetNbinsX(); ++xi)
  {
    for (int yi = 0; yi < h2_zjt_ptbinned_sys_shapeclosure_sq[i-1]->GetNbinsY(); ++yi)
    {
  ...
  h2_zjt_ptbinned_sys_unfold_sq[i-1]->Scale(1. / 4.);
  ...
  h2_zjt_ptbinned_sys_total[i-1]->Add(h2_zjt_ptbinned_sys_jesjer_sq[i-1]);
  ...
  h2_zr_ptbinned_sys_jesjer_sq[i-1]->Multiply(h2_zr_ptbinned_sys_jesjer[i-1], h2_zr_ptbinned_sys_jesjer[i-1]);
  ...
  {
    for (int yi = 0; yi < h2_zr_ptbinned_sys_closure_sq[i-1]->GetNbinsY(); ++yi)
    {
      h2_zr_ptbinned_sys_closure_sq[i-1]->SetBinContent(xi, yi, h2_zr_ptbinned_sys_closure_sq[i-1]->GetBinContent(xi, yi) - h2_zr_ptbinned_sys_closure_sq[i-1]->GetBinError(xi, yi));
    }
  }
  for (int xi = 0; xi < h2_zr_ptbinned_sys_shapeclosure_sq[i-1]->GetNbinsX(); ++xi)
  {
    for (int yi = 0; yi < h2_zr_ptbinned_sys_shapeclosure_sq[i-1]->GetNbinsY(); ++yi)
    {
      h2_zr_ptbinned_sys_shapeclosure_sq[i-1]->SetBinContent(xi, yi, h2_zr_ptbinned_sys_shapeclosure_sq[i-1]->GetBinContent(xi, yi) - h2_zr_ptbinned_sys_shapeclosure_sq[i-1]->GetBinError(xi, yi));
    }
  }
  MakeHistPositive(h2_zr_ptbinned_sys_closure_sq[i-1]);
  MakeHistPositive(h2_zr_ptbinned_sys_shapeclosure_sq[i-1]);
  ...
  h2_zr_ptbinned_sys_unfold_sq[i-1]->Scale(1. / 4.);
  ...
  h2_zr_ptbinned_sys_total[i-1]->Add(h2_zr_ptbinned_sys_jesjer_sq[i-1]);
  ...
  h2_jtr_ptbinned_sys_jesjer_sq[i-1]->Multiply(h2_jtr_ptbinned_sys_jesjer[i-1], h2_jtr_ptbinned_sys_jesjer[i-1]);
  ...
  for (int xi = 0; xi < h2_jtr_ptbinned_sys_closure_sq[i-1]->GetNbinsX(); ++xi)
  {
    for (int yi = 0; yi < h2_jtr_ptbinned_sys_closure_sq[i-1]->GetNbinsY(); ++yi)
    {
      h2_jtr_ptbinned_sys_closure_sq[i-1]->SetBinContent(xi, yi, h2_jtr_ptbinned_sys_closure_sq[i-1]->GetBinContent(xi, yi) - h2_jtr_ptbinned_sys_closure_sq[i-1]->GetBinError(xi, yi));
    }
  }
  for (int xi = 0; xi < h2_jtr_ptbinned_sys_shapeclosure_sq[i-1]->GetNbinsX(); ++xi)
  {
    for (int yi = 0; yi < h2_jtr_ptbinned_sys_shapeclosure_sq[i-1]->GetNbinsY(); ++yi)
    {
      h2_jtr_ptbinned_sys_shapeclosure_sq[i-1]->SetBinContent(xi, yi, h2_jtr_ptbinned_sys_shapeclosure_sq[i-1]->GetBinContent(xi, yi) - h2_jtr_ptbinned_sys_shapeclosure_sq[i-1]->GetBinError(xi, yi));
    }
  }
  MakeHistPositive(h2_jtr_ptbinned_sys_closure_sq[i-1]);
  MakeHistPositive(h2_jtr_ptbinned_sys_shapeclosure_sq[i-1]);
  ...
  h2_jtr_ptbinned_sys_unfold_sq[i-1]->Scale(1. / 4.);
  ...
  h2_jtr_ptbinned_sys_total[i-1]->Add(h2_jtr_ptbinned_sys_jesjer_sq[i-1]);
  ...
  vec_sys_z_ptbinned[i-1].push_back(h1_z_ptbinned_sys_jesjer[i-1]);
  ...
  vec_sys_jt_ptbinned[i-1].push_back(h1_jt_ptbinned_sys_jesjer[i-1]);
  ...
  vec_sys_r_ptbinned[i-1].push_back(h1_r_ptbinned_sys_jesjer[i-1]);
  ...
  vec_sys_zjt_ptbinned[i-1].push_back(h2_zjt_ptbinned_sys_jesjer[i-1]);
  ...
  vec_sys_zr_ptbinned[i-1].push_back(h2_zr_ptbinned_sys_jesjer[i-1]);
  ...
  vec_sys_jtr_ptbinned[i-1].push_back(h2_jtr_ptbinned_sys_jesjer[i-1]);
  ...
  h1_z_ptbinned_sys_jesjer[i-1]->SetName(Form("z_sys_jesjer_pt%d", i));
  ...
  h1_jt_ptbinned_sys_jesjer[i-1]->SetName(Form("jt_sys_jesjer_pt%d", i));
  ...
  h1_r_ptbinned_sys_jesjer[i-1]->SetName(Form("r_sys_jesjer_pt%d", i));
  ...
  h2_zjt_ptbinned_sys_jesjer[i-1]->SetName(Form("zjt_sys_jesjer_pt%d", i)); 
  ...
  h2_zr_ptbinned_sys_jesjer[i-1]->SetName(Form("zr_sys_jesjer_pt%d", i)); 
  ...
  h2_jtr_ptbinned_sys_jesjer[i-1]->SetName(Form("jtr_sys_jesjer_pt%d", i));
  ...
  */
  ...
  h1_z_ptbinned_sys_jesjer[i-1]->Write();   
  ...
  h1_jt_ptbinned_sys_jesjer[i-1]->Write();      
  ...
  h1_r_ptbinned_sys_jesjer[i-1]->Write();
  ...
  h2_zjt_ptbinned_sys_jesjer[i-1]->Write(); 
  ...
  h2_zr_ptbinned_sys_jesjer[i-1]->Write();
  ...
  h2_jtr_ptbinned_sys_jesjer[i-1]->Write(); 
  ...
  for (int i=1; i<ptbinsize; ++i)
  {
    ...
    for (int j = 0; j < vec_sys_z_ptbinned[i-1].size(); j++)
    {
      ...
      h1_z_ptbinned_sys->GetXaxis()->SetRangeUser(0.1, 1.0);
      ...
      */
      ...
      h1_z_ptbinned_sys->SetMaximum(1.5);
      h1_z_ptbinned_sys->SetMinimum(-1.5);
    }
    
    //h1_z_ptbinned_sys_jesjer[i-1]->Draw("SAME");
  ...
  for (int i=1; i<ptbinsize; ++i)
  {
    ...
    for (int j = 0; j < vec_sys_jt_ptbinned[i-1].size(); j++)
    {
      ...
      */
      ...
      h1_jt_ptbinned_sys->SetMaximum(1.5);
      h1_jt_ptbinned_sys->SetMinimum(-1.5);
    }
    
    //h1_jt_ptbinned_sys_jesjer[i-1]->Draw("SAME");
  ...
  for (int i=1; i<ptbinsize; ++i)
  {
    ...
    for (int j = 0; j < vec_sys_r_ptbinned[i-1].size(); j++)
    {
      ...
      h1_r_ptbinned_sys->GetXaxis()->SetRangeUser(0.0, 0.4);
      ...
      */
      ...
      h1_r_ptbinned_sys->SetMaximum(1.5);
      h1_r_ptbinned_sys->SetMinimum(-1.5);
    }
    //h1_r_ptbinned_sys_jesjer[i-1]->Draw("SAME");
