...
//    int nentries = 500000;
    TString outfileName = Form("/Users/josearias18/Desktop/QCDc2/pythia/Root_Files/Bjets/Bjets_DM_Variable_Tree_%d.root", nentries);
    ...
    TTree *Bjet_tree = new TTree("Bjet", "A tree with B hadrons in jets from DiMuon Stream");
    ...
    Bjet_tree->Branch("Jpsi_m", &Jpsi_m);
    ...
    Bjet_tree->Branch("bm_constrained", &bm_constrained);
...
//    int MaxSV =0;
    ...
    for (int jentry = 0; jentry < nentries; jentry++) { //Long64_t
        ...
        TLorentzVector jet4P, mup4P, mum4P, Kmeson4P, Jpsi, HFmeson;
...
//        cout<< "Event: " << jentry << endl;
        // Investigating Jet's daughters when the SV > 1
//        for (int i =0; i<Jet_Dtr_nrecodtr; i++)
//        {
//            if( Jet_SVTag_Nvertices==1)
//            {
//                cout<<" Jet Daugthers (SV=1) : " << Jet_Dtr_ID[i] << endl;
//            }
//
//            if( Jet_SVTag_Nvertices==2)
//            {
//                cout<<" Jet Daugthers (SV=2) : " << Jet_Dtr_ID[i] << endl;
//            }
//
//            if( Jet_SVTag_Nvertices==3)
//            {
//                cout<<" Jet Daugthers (SV=3) : " << Jet_Dtr_ID[i] << endl;
//            }
//        }
...
//    cout << "Jets with a Fake HF: " << HF_notreal <<endl;
