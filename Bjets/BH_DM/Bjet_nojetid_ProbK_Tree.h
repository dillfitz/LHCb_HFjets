...
// Wed Mar 22 16:25:59 2023 by ROOT version 6.24/08
// from TChain Jets/DecayTree/
//////////////////////////////////////////////////////////

#ifndef Bjet_nojetid_ProbK_Tree_h
#define Bjet_nojetid_ProbK_Tree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Bjet_nojetid_ProbK_Tree(TTree *tree=0);
   virtual ~Bjet_nojetid_ProbK_Tree();
...
#ifdef Bjet_nojetid_ProbK_Tree_cxx
Bjet_nojetid_ProbK_Tree::Bjet_nojetid_ProbK_Tree(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("Bjet_nojetid_2016_MD_11252022_url423_0_800.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2016_MD_11252022_url423_800_1426.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2016_MU_11252022_url424_0_800.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2016_MU_11252022_url424_800_1315.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2017_MD_11252022_url425_0_800.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2017_MD_11252022_url425_800_877.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2017_MU_11252022_url426_0_800.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2017_MU_11252022_url426_800_847.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2018_MD_11252022_url427_0_800.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2018_MD_11252022_url427_800_989.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2018_MU_11252022_url428_0_800.root/Jets/DecayTree");
      chain->Add("Bjet_nojetid_2018_MU_11252022_url428_800_1040.root/Jets/DecayTree");
      tree = chain;
#endif // SINGLE_TREE
...
Bjet_nojetid_ProbK_Tree::~Bjet_nojetid_ProbK_Tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Bjet_nojetid_ProbK_Tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Bjet_nojetid_ProbK_Tree::LoadTree(Long64_t entry)
{
...
void Bjet_nojetid_ProbK_Tree::Init(TTree *tree)
{
...
Bool_t Bjet_nojetid_ProbK_Tree::Notify()
{
...
void Bjet_nojetid_ProbK_Tree::Show(Long64_t entry)
{
...
Int_t Bjet_nojetid_ProbK_Tree::Cut(Long64_t entry)
{
...
#endif // #ifdef Bjet_nojetid_ProbK_Tree_cxx
