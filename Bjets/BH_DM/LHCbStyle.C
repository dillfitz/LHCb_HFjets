...
//    lhcbStyle->SetPalette(8,colors);
    ...
    lhcbStyle->SetPadRightMargin(0.12); // increase for colz plots 0.05 , 0.12 for Colz 
    lhcbStyle->SetPadBottomMargin(0.16);
    lhcbStyle->SetPadLeftMargin(0.19); // Default: 0.14
    ...
    lhcbStyle->SetMarkerSize(0.6); //1.0
...
//    lhcbStyle->SetStatFormat("6.3g"); // specified as c printf options
    ...
    //titles
    lhcbStyle->SetTitleOffset(0.85,"X"); //0.95
    ...
    lhcbStyle->SetNdivisions(505,"x"); //505
