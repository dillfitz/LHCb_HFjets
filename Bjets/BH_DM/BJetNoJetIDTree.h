...
#ifndef BJetNoJetIDTree_h
#define BJetNoJetIDTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BJetNoJetIDTree(TTree *tree=0);
   virtual ~BJetNoJetIDTree();
...
#ifdef BJetNoJetIDTree_cxx
BJetNoJetIDTree::BJetNoJetIDTree(TTree *tree) : fChain(0) 
{
...
BJetNoJetIDTree::~BJetNoJetIDTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BJetNoJetIDTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BJetNoJetIDTree::LoadTree(Long64_t entry)
{
...
void BJetNoJetIDTree::Init(TTree *tree)
{
...
void BJetNoJetIDTree::Show(Long64_t entry)
{
...
Int_t BJetNoJetIDTree::Cut(Long64_t entry)
{
