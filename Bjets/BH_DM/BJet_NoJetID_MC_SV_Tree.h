...
// Thu Mar  9 18:25:38 2023 by ROOT version 6.24/08
// from TChain Jets/DecayTree/
//////////////////////////////////////////////////////////

#ifndef BJet_NoJetID_MC_SV_Tree_h
#define BJet_NoJetID_MC_SV_Tree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BJet_NoJetID_MC_SV_Tree(TTree *tree=0);
   virtual ~BJet_NoJetID_MC_SV_Tree();
...
#ifdef BJet_NoJetID_MC_SV_Tree_cxx
BJet_NoJetID_MC_SV_Tree::BJet_NoJetID_MC_SV_Tree(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("Bjet_MC_nojetid_Sim10a_MU_02092023_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim10a_MD_02092023_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09k_MU_02092023_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09k_MD_02092023_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09g_MU_02092023_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09g_MD_02092023_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09b_MU_02092023_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09b_MD_02092023_full.root/Jets/DecayTree");
      tree = chain;
#endif // SINGLE_TREE
...
BJet_NoJetID_MC_SV_Tree::~BJet_NoJetID_MC_SV_Tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BJet_NoJetID_MC_SV_Tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BJet_NoJetID_MC_SV_Tree::LoadTree(Long64_t entry)
{
...
void BJet_NoJetID_MC_SV_Tree::Init(TTree *tree)
{
...
Bool_t BJet_NoJetID_MC_SV_Tree::Notify()
{
...
void BJet_NoJetID_MC_SV_Tree::Show(Long64_t entry)
{
...
Int_t BJet_NoJetID_MC_SV_Tree::Cut(Long64_t entry)
{
...
#endif // #ifdef BJet_NoJetID_MC_SV_Tree_cxx
