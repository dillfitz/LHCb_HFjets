...
// Fri Apr 28 18:09:14 2023 by ROOT version 6.24/08
// from TChain Jets/DecayTree/
//////////////////////////////////////////////////////////

#ifndef B_Tree_DM_Comp_h
#define B_Tree_DM_Comp_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   B_Tree_DM_Comp(TTree *tree=0);
   virtual ~B_Tree_DM_Comp();
...
#ifdef B_Tree_DM_Comp_cxx
B_Tree_DM_Comp::B_Tree_DM_Comp(TTree *tree) : fChain(0) 
{
...
B_Tree_DM_Comp::~B_Tree_DM_Comp()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t B_Tree_DM_Comp::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t B_Tree_DM_Comp::LoadTree(Long64_t entry)
{
...
void B_Tree_DM_Comp::Init(TTree *tree)
{
...
void B_Tree_DM_Comp::Show(Long64_t entry)
{
...
Int_t B_Tree_DM_Comp::Cut(Long64_t entry)
{
...
#endif // #ifdef B_Tree_DM_Comp_cxx
