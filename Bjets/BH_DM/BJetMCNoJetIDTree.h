...
#ifndef BJetMCNoJetIDTree_h
#define BJetMCNoJetIDTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BJetMCNoJetIDTree(TTree *tree=0);
   virtual ~BJetMCNoJetIDTree();
...
#ifdef BJetMCNoJetIDTree_cxx
BJetMCNoJetIDTree::BJetMCNoJetIDTree(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("Bjet_MC_nojetid_Sim09b_MD_11222022_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09b_MU_11222022_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09g_MD_11222022_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09g_MU_11222022_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09k_MD_11222022_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim09k_MU_11222022_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim10a_MD_11222022_full.root/Jets/DecayTree");
      chain->Add("Bjet_MC_nojetid_Sim10a_MU_11222022_full.root/Jets/DecayTree");
...
BJetMCNoJetIDTree::~BJetMCNoJetIDTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BJetMCNoJetIDTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BJetMCNoJetIDTree::LoadTree(Long64_t entry)
{
...
void BJetMCNoJetIDTree::Init(TTree *tree)
{
...
Bool_t BJetMCNoJetIDTree::Notify()
{
...
void BJetMCNoJetIDTree::Show(Long64_t entry)
{
...
Int_t BJetMCNoJetIDTree::Cut(Long64_t entry)
{
