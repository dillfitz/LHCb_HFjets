#define BJetNoJetIDOppBStatTree_cxx
#include "BJetNoJetIDOppBStatTree.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void BJetNoJetIDOppBStatTree::Loop()
{
...
//int nentries = 100000;
TString outfileName = Form("/Users/josearias18/Desktop/QCDc2/pythia/Root_Files/Bjets/BJets_BH_OneBjets_%d.root", nentries);
TFile *outfile = new TFile(outfileName, "RECREATE");

//Integrated Histograms
TH1F *bMH = new TH1F("m", ";m_{#mu#mu K^{#pm}} (GeV/c^{2});", 175, 5.0, 5.7);
TH1F *zH = new TH1F("z",";#it{z};", 120, 0.0, 1.1);
TH1F *jtH = new TH1F("jt",";j_{T} (GeV/c);", 125, 0., 10.);   //good shapes with 200 bins for 1 M for z and jt
TH1F *rH = new TH1F("r",";r;", 120, 0., 7.);
TH1F *bJetPtH = new TH1F("pt", ";p_{T} (GeV/c);", 120, 20., 200.);
TH2F *jPH = new TH2F("Pvspt", ";p_{T};|P_{jet}|", 120, 15., 200., 175, 0., 3000.);
TH2F *jtzH = new TH2F("Fzjt", ";#it{z}; j_{T} (GeV)" , 100, 0.0, 1.1, 100, 0., 10.);
TH2F *zRH = new TH2F("z_R", ";#it{z}; r" , 100, 0.0, 1.1, 100, 0., 7.);

//Pt Binned Histograms
//20<pt<30 GeV/c
TH1F *bMH_20_30 = new TH1F("m_20_30", ";m_{#mu#mu K^{#pm}} (GeV/c^{2});" ,175, 5.0, 5.7);
TH1F *zH_20_30 = new TH1F("z_20_30", ";#it{z};" , 100, 0.0, 1.1);
TH1F *zH_0_500p = new TH1F("z_0_500p", ";#it{z};" , 100, 0.0, 1.1);
TH1F *jtH_20_30 = new TH1F("jt_20_30", ";j_{T} (GeV);", 100, 0., 10.);
TH1F *rH_20_30 = new TH1F("r (20 Gev/c < p_T < 30 GeV/c)", ";r;", 100, 0., 7.);
TH2F *jtzH_20_30 = new TH2F(";z vs. j_T (20 Gev/c < p_T < 30 GeV/c);", ";#it{z}; j_{T} (GeV)", 100, 0.0, 1.1, 100, 0., 10.);
TH2F *zRH_20_30 = new TH2F(";z vs. r) (20 Gev/c < p_T < 30 GeV/c);", ";#it{z}; r", 100, 0.0, 1.1, 100, 0., 7.);
...
TH1F *rH_30_50 = new TH1F("r (30 Gev/c < p_T < 50 GeV/c)", ";r;", 100, 0., 7.);
TH2F *jtzH_30_50 = new TH2F(";D (z,j_T) (30 Gev/c < p_T < 50 GeV/c);", ";#it{z}; j_{T}", 100, 0.0, 1.1, 100, 0., 10.);
TH2F *zRH_30_50 = new TH2F(";z vs. r (30 Gev/c < p_T < 50 GeV/c);", ";#it{z}; r", 100, 0.0, 1.1, 100, 0., 7.);

//50<pt<100 GeV/c
TH1F *bMH_50_100 = new TH1F("m_50_100", ";m_{#mu#mu K^{#pm}} (GeV/c^{2});" ,70, 5.0, 5.7);
...
TH1F *rH_50_100 = new TH1F("r (50 Gev/c < p_T < 100 GeV/c)", ";r;", 50, 0., 7.);
TH2F *jtzH_50_100 = new TH2F(";D(z,j_T) (50 Gev/c < p_T < 100 GeV/c);", ";#it{z}; j_{T}", 50, 0.0, 1.1, 50, 0., 10.);
TH2F *zRH_50_100 = new TH2F(";z vs. r) (50 Gev/c < p_T < 100 GeV/c);", ";#it{z}; r", 50, 0.0, 1.1, 50, 0., 7.);

TH1F *zH_1500p = new TH1F("z_1500p", ";D_{p}^{B^{#pm}} (z);" , 30, 0.0, 1.1);
    
TH1F *bDphi = new TH1F("bDphi", ";dphi;", 175, 0.0, 3.1450);
...
//      if (dphi<3.0) {continue;}
      ...
      for (int j=0; j<Jet_Dtr_nrecodtr; ++j)
      {
          if ( abs( Jet_Dtr_ID[j] ) == 521)  //here
          {
              ...
              //bM  = b4vec.M();
              //cout << bM << endl;
              TLorentzVector j4vec(Jet_PX/1000., Jet_PY/1000., Jet_PZ/1000., Jet_PE/1000.);
...
//              bR = sqrt(pow(jet3vec.Eta() - b3vec.Eta(), 2) + phiDiffSqVec.at(std::distance(phiDiffSqVec.begin(), rPhiDiffSq)));
              ...
              if (bM >= 5.2791-0.030 && bM <= 5.2791+0.030)
              { bMH->Fill(bM);
              ...
              if (bM >= 5.2791-0.0281 && bM <= 5.2791+0.0281)
              {
              ...
              if (bM >= 5.2781-0.024 && bM <= 5.2781+0.024)
              {
              ...
              if (bM >= 5.279-0.048 && bM <= 5.279+0.048)
              {
    ...
    c1->SaveAs("/Users/josearias18/Desktop/QCDc2/pythia/Plots/Bjets/jt_r_dphi25_BJets.pdf");
    c2->SaveAs("/Users/josearias18/Desktop/QCDc2/pythia/Plots/Bjets/jt_r_0_3_dphi25_BJets.pdf");
