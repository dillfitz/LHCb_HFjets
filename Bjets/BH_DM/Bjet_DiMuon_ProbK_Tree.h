...
// Thu Mar 23 15:31:06 2023 by ROOT version 6.24/08
// from TChain Jets/DecayTree/
//////////////////////////////////////////////////////////

#ifndef Bjet_DiMuon_ProbK_Tree_h
#define Bjet_DiMuon_ProbK_Tree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Bjet_DiMuon_ProbK_Tree(TTree *tree=0);
   virtual ~Bjet_DiMuon_ProbK_Tree();
...
#ifdef Bjet_DiMuon_ProbK_Tree_cxx
Bjet_DiMuon_ProbK_Tree::Bjet_DiMuon_ProbK_Tree(TTree *tree) : fChain(0) 
{
...
Bjet_DiMuon_ProbK_Tree::~Bjet_DiMuon_ProbK_Tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Bjet_DiMuon_ProbK_Tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Bjet_DiMuon_ProbK_Tree::LoadTree(Long64_t entry)
{
...
void Bjet_DiMuon_ProbK_Tree::Init(TTree *tree)
{
...
Bool_t Bjet_DiMuon_ProbK_Tree::Notify()
{
...
void Bjet_DiMuon_ProbK_Tree::Show(Long64_t entry)
{
...
Int_t Bjet_DiMuon_ProbK_Tree::Cut(Long64_t entry)
{
...
#endif // #ifdef Bjet_DiMuon_ProbK_Tree_cxx
