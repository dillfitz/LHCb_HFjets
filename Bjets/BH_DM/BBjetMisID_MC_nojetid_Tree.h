...
// Tue Mar 14 15:04:16 2023 by ROOT version 6.24/08
// from TChain Jets/DecayTree/
//////////////////////////////////////////////////////////

#ifndef BBjetMisID_MC_nojetid_Tree_h
#define BBjetMisID_MC_nojetid_Tree_h
...
class BBjetMisID_MC_nojetid_Tree {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BBjetMisID_MC_nojetid_Tree(TTree *tree=0);
   virtual ~BBjetMisID_MC_nojetid_Tree();
...
#ifdef BBjetMisID_MC_nojetid_Tree_cxx
BBjetMisID_MC_nojetid_Tree::BBjetMisID_MC_nojetid_Tree(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/Users/josearias18/Desktop/QCDc2/pythia/Data/BjetMisID_MC_nojetid_Sim09l_MU_12122022_full.root/Jets/DecayTree");
      chain->Add("/Users/josearias18/Desktop/QCDc2/pythia/Data/BjetMisID_MC_nojetid_Sim09l_MD_12122022_full.root/Jets/DecayTree");
      tree = chain;
#endif // SINGLE_TREE
...
BBjetMisID_MC_nojetid_Tree::~BBjetMisID_MC_nojetid_Tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BBjetMisID_MC_nojetid_Tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BBjetMisID_MC_nojetid_Tree::LoadTree(Long64_t entry)
{
...
void BBjetMisID_MC_nojetid_Tree::Init(TTree *tree)
{
...
Bool_t BBjetMisID_MC_nojetid_Tree::Notify()
{
...
void BBjetMisID_MC_nojetid_Tree::Show(Long64_t entry)
{
...
Int_t BBjetMisID_MC_nojetid_Tree::Cut(Long64_t entry)
{
...
#endif // #ifdef BBjetMisID_MC_nojetid_Tree_cxx
