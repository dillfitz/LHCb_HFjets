...
void L0TOSCompare()
{
    ...
    TH2D *ptz_all = (TH2D*)infile_all.Get("ptz_uncorrected");
    NormalizeHist(ptz_all);
    TH2D *ptz_L0DiMuon = (TH2D*)infile_L0DiMuon.Get("ptz_uncorrected");
    ...
    TH2D *ptjt_all = (TH2D*)infile_all.Get("ptjt_uncorrected");
    NormalizeHist(ptjt_all);
    TH2D *ptjt_L0DiMuon = (TH2D*)infile_L0DiMuon.Get("ptjt_uncorrected");
    ...
    TH2D *ptr_all = (TH2D*)infile_all.Get("ptr_uncorrected");
    NormalizeHist(ptr_all);
    TH2D *ptr_L0DiMuon = (TH2D*)infile_L0DiMuon.Get("ptr_uncorrected");
