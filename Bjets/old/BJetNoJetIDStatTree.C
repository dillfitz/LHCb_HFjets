#define BJetNoJetIDStatTree_cxx
#include "BJetNoJetIDStatTree.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
//int nentries = 50000;
TString outfileName = Form("BJetsNoJetID_MassCut_All_%d.root", nentries);
TFile *outfile = new TFile(outfileName, "RECREATE");

//Integrated Histograms
TH1F *bMH = new TH1F("m", ";m_{B^{#pm}} (MeV/c^{2});", 175, 5.0, 5.7);
TH1F *zH = new TH1F("z",";z;", 150, 0.0, 1.1);
TH1F *jtH = new TH1F("jt",";j_{T} (GeV/c);", 150, 0., 10.);   //good shapes with 200 bins for 1 M for z and jt
...
TH2F *jtzH = new TH2F("Fzjt", ";#it{z}; j_{T}" , 150, 0.0, 1.1, 150, 0., 10.);
TH2F *zRH = new TH2F("z_R", ";#it{z}; r" , 175, 0.0, 1.1, 175, 0., 7.);

//Pt Binned Histograms
TH1F *bMH_20_30 = new TH1F("m_20_30", ";m_{#mu#mu K^{#pm}} (MeV/c^{2});" ,175, 5.0, 5.7);
TH1F *zH_20_30 = new TH1F("z_20_30", ";D_{p}^{B^{#pm}} (z);" , 150, 0.0, 1.1);
...
TH2F *jtzH_20_30 = new TH2F(";D(z,j_T) (20 Gev/c < p_T < 30 GeV/c);", ";#it{z}; j_{T}", 150, 0.0, 1.1, 150, 0., 10.);
TH2F *zRH_20_30 = new TH2F(";z vs. r) (20 Gev/c < p_T < 30 GeV/c);", ";#it{z}; r", 120, 0.0, 1.1, 120, 0., 7.);

TH1F *bMH_30_50 = new TH1F("m_30_50", ";m_{#mu#mu K^{#pm}} (MeV/c^{2});" ,175, 5.0, 5.7);
...
TH1F *bMH_50_100 = new TH1F("m_50_100", ";m_{#mu#mu K^{#pm}} (MeV/c^{2});" ,175, 5.0, 5.7);
TH1F *zH_50_100 = new TH1F("z_50_100", ";D_{p}^{B^{#pm}} (z);" , 100, 0.0, 1.1);
TH1F *zH_1000_1500p = new TH1F("z_1000_1500p", ";D_{p}^{B^{#pm}} (z);" , 50, 0.0, 1.1);
TH1F *jtH_50_100 = new TH1F("jt_50_100", ";D_{p}^{B^{#pm}} (j_T);", 100, 0., 10.);
TH1F *rH_50_100 = new TH1F("r (50 Gev/c < p_T < 100 GeV/c)", ";r;", 100, 0., 7.);
TH2F *jtzH_50_100 = new TH2F(";D(z,j_T) (50 Gev/c < p_T < 100 GeV/c);", ";#it{z}; j_{T}", 100, 0.0, 1.1, 100, 0., 10.);
TH2F *zRH_50_100 = new TH2F(";z vs. r) (50 Gev/c < p_T < 100 GeV/c);", ";#it{z}; r", 100, 0.0, 1.1, 100, 0., 7.);
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) 
  {
      ...
      for (int j=0; j<Jet_Dtr_nrecodtr; ++j)
      {
          if ( abs( Jet_Dtr_ID[j] ) == 521 )
          {
              ...
              if (bM >= 5.278788-0.02803 && bM <= 5.278788+0.02803)
              {
                  bMH->Fill(bM);
              ...
              if (bM >= 5.27885-0.0269 && bM <= 5.27885+0.0269)
              {
              ...
              if (bM >= 5.2784-0.033 && bM <= 5.2784+0.033)
              {
              ...
              if (bM >= 5.2795-0.0254 && bM <= 5.2795+0.0254)
              {
...
///THIS WORKS!!! ///
    ...
    c1->SaveAs("jt_r_All.pdf");
    c2->SaveAs("jt_r_0_3_All.pdf");
