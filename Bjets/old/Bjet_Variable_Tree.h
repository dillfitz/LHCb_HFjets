...
#ifndef Bjet_Variable_Tree_h
#define Bjet_Variable_Tree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Bjet_Variable_Tree(TTree *tree=0);
   virtual ~Bjet_Variable_Tree();
...
#ifdef Bjet_Variable_Tree_cxx
Bjet_Variable_Tree::Bjet_Variable_Tree(TTree *tree) : fChain(0) 
{
...
Bjet_Variable_Tree::~Bjet_Variable_Tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Bjet_Variable_Tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Bjet_Variable_Tree::LoadTree(Long64_t entry)
{
...
void Bjet_Variable_Tree::Init(TTree *tree)
{
...
Bool_t Bjet_Variable_Tree::Notify()
{
...
void Bjet_Variable_Tree::Show(Long64_t entry)
{
...
Int_t Bjet_Variable_Tree::Cut(Long64_t entry)
{
