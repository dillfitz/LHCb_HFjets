...
#ifndef BJetNoJetIDStatTree_h
#define BJetNoJetIDStatTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BJetNoJetIDStatTree(TTree *tree=0);
   virtual ~BJetNoJetIDStatTree();
...
#ifdef BJetNoJetIDStatTree_cxx
BJetNoJetIDStatTree::BJetNoJetIDStatTree(TTree *tree) : fChain(0)
{
...
BJetNoJetIDStatTree::~BJetNoJetIDStatTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BJetNoJetIDStatTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BJetNoJetIDStatTree::LoadTree(Long64_t entry)
{
...
void BJetNoJetIDStatTree::Init(TTree *tree)
{
...
Bool_t BJetNoJetIDStatTree::Notify()
{
...
void BJetNoJetIDStatTree::Show(Long64_t entry)
{
...
Int_t BJetNoJetIDStatTree::Cut(Long64_t entry)
{
