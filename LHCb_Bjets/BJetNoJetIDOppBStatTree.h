...
// Thu Sep 22 18:21:09 2022 by ROOT version 6.18/04
// from TChain Jets/DecayTree/
//////////////////////////////////////////////////////////

#ifndef BJetNoJetIDOppBStatTree_h
#define BJetNoJetIDOppBStatTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BJetNoJetIDOppBStatTree(TTree *tree=0);
   virtual ~BJetNoJetIDOppBStatTree();
...
#ifdef BJetNoJetIDOppBStatTree_cxx
BJetNoJetIDOppBStatTree::BJetNoJetIDOppBStatTree(TTree *tree) : fChain(0)
{
...
BJetNoJetIDOppBStatTree::~BJetNoJetIDOppBStatTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BJetNoJetIDOppBStatTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BJetNoJetIDOppBStatTree::LoadTree(Long64_t entry)
{
...
void BJetNoJetIDOppBStatTree::Init(TTree *tree)
{
...
Bool_t BJetNoJetIDOppBStatTree::Notify()
{
...
void BJetNoJetIDOppBStatTree::Show(Long64_t entry)
{
...
Int_t BJetNoJetIDOppBStatTree::Cut(Long64_t entry)
{
...
#endif // #ifdef BJetNoJetIDTree_cxx
