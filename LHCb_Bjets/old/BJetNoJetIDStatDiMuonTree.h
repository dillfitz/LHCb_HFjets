...
#ifndef BJetNoJetIDStatDiMuonTree_h
#define BJetNoJetIDStatDiMuonTree_h
...
class BJetNoJetIDStatDiMuonTree {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BJetNoJetIDStatDiMuonTree(TTree *tree=0);
   virtual ~BJetNoJetIDStatDiMuonTree();
...
#ifdef BJetNoJetIDStatDiMuonTree_cxx
BJetNoJetIDStatDiMuonTree::BJetNoJetIDStatDiMuonTree(TTree *tree) : fChain(0)
{
...
BJetNoJetIDStatDiMuonTree::~BJetNoJetIDStatDiMuonTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BJetNoJetIDStatDiMuonTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BJetNoJetIDStatDiMuonTree::LoadTree(Long64_t entry)
{
...
void BJetNoJetIDStatDiMuonTree::Init(TTree *tree)
{
...
Bool_t BJetNoJetIDStatDiMuonTree::Notify()
{
...
void BJetNoJetIDStatDiMuonTree::Show(Long64_t entry)
{
...
Int_t BJetNoJetIDStatDiMuonTree::Cut(Long64_t entry)
{
