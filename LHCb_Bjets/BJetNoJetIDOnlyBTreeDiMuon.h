...
#ifndef BJetNoJetIDOnlyBTreeDiMuon_h
#define BJetNoJetIDOnlyBTreeDiMuon_h
...
class BJetNoJetIDOnlyBTreeDiMuon {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BJetNoJetIDOnlyBTreeDiMuon(TTree *tree=0);
   virtual ~BJetNoJetIDOnlyBTreeDiMuon();
...
#ifdef BJetNoJetIDOnlyBTreeDiMuon_cxx
BJetNoJetIDOnlyBTreeDiMuon::BJetNoJetIDOnlyBTreeDiMuon(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("Bjet_Data_dimuon_2016_MD_01312023_full.root/Jets/DecayTree");
      chain->Add("Bjet_Data_dimuon_2016_MD_02012023_full.root/Jets/DecayTree");
      chain->Add("Bjet_Data_dimuon_2016_MU_02012023_full.root/Jets/DecayTree");
      chain->Add("Bjet_Data_dimuon_2017_MD_02012023_full.root/Jets/DecayTree");
      chain->Add("Bjet_Data_dimuon_2017_MU_02012023_full.root/Jets/DecayTree");
      chain->Add("Bjet_Data_dimuon_2018_MD_02012023_full.root/Jets/DecayTree");
      chain->Add("Bjet_Data_dimuon_2018_MU_02012023_full.root/Jets/DecayTree");
      tree = chain;
#endif // SINGLE_TREE
...
BJetNoJetIDOnlyBTreeDiMuon::~BJetNoJetIDOnlyBTreeDiMuon()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BJetNoJetIDOnlyBTreeDiMuon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BJetNoJetIDOnlyBTreeDiMuon::LoadTree(Long64_t entry)
{
...
void BJetNoJetIDOnlyBTreeDiMuon::Init(TTree *tree)
{
...
Bool_t BJetNoJetIDOnlyBTreeDiMuon::Notify()
{
...
void BJetNoJetIDOnlyBTreeDiMuon::Show(Long64_t entry)
{
...
Int_t BJetNoJetIDOnlyBTreeDiMuon::Cut(Long64_t entry)
{
