...
//int nentries = 100000;
TString outfileName = Form("BJetsNoJetID_MassCut_OnlyB_%d.root", nentries);
...
TH2F *jtzH_20_30 = new TH2F(";D(z,j_T) (20 Gev/c < p_T < 30 GeV/c);", ";#it{z}; j_{T}", 120, 0.0, 1.1, 120, 0., 10.);
...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) 
  {
    ...
    c1->SaveAs("jt_r_BJets.pdf");
    c2->SaveAs("jt_r_0_3_BJets.pdf");
