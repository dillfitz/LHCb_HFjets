...
// Wed Feb 14 19:31:53 2024 by ROOT version 6.24/08
// from TChain Jpsi2MuMu/DecayTree/
//////////////////////////////////////////////////////////

#ifndef JpsiRecoTree_h
#define JpsiRecoTree_h
...
public:
   ...
   JpsiRecoTree(TTree *tree = 0);
   virtual ~JpsiRecoTree();
...
#ifdef JpsiRecoTree_cxx
JpsiRecoTree::JpsiRecoTree(TTree *tree) : fChain(0)
{
   ...
   if (tree == 0)
   {
      ...
      chain->Add("Jpsi2MuMu_MC_2016_Sim09k_MD_02142024_full.root/Jpsi2MuMu/DecayTree");
      tree = chain;
#endif // SINGLE_TREE
   }
   Init(tree);
...
Int_t JpsiRecoTree::GetEntry(Long64_t entry)
{
...
Long64_t JpsiRecoTree::LoadTree(Long64_t entry)
{
...
void JpsiRecoTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("J_psi_1S0_TRUEID", &J_psi_1S0_TRUEID, &b_J_psi_1S0_TRUEID);
...
void JpsiRecoTree::Show(Long64_t entry)
{
...
Int_t JpsiRecoTree::Cut(Long64_t entry)
{
